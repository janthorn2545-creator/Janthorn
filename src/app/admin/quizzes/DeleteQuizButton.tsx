...
export default function DeleteQuizButton({ quizId, courseId }: { quizId: string; courseId: string }) {
    ...
    return (
      <div className="flex gap-1">
        <button onClick={handleDelete} disabled={loading}
          className="text-xs text-white bg-red-600 hover:bg-red-700 px-2.5 py-1 rounded-lg transition-colors disabled:opacity-60">
          {loading ? '...' : 'ยืนยันลบ'}
        </button>
